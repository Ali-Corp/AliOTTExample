package vn.ali.ott.example.hotline.widget;
...
import vn.ali.ott.example.hotline.R;
...
public class RipplePulseLayout extends RelativeLayout {
    ...
    public RipplePulseLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attr = context.getTheme().obtainStyledAttributes(
                attrs, R.styleable.RipplePulseLayout, 0, 0);
        ...
        try {
            mCount = attr.getInteger(R.styleable.RipplePulseLayout_pulse_count, DEFAULT_COUNT);
            mDuration = attr.getInteger(R.styleable.RipplePulseLayout_pulse_duration,
                    DEFAULT_DURATION);
            mRepeat = attr.getInteger(R.styleable.RipplePulseLayout_pulse_repeat, DEFAULT_REPEAT);
            mStartFromScratch = attr.getBoolean(R.styleable.RipplePulseLayout_pulse_startFromScratch,
                    DEFAULT_START_FROM_SCRATCH);
            mColor = attr.getColor(R.styleable.RipplePulseLayout_pulse_color, DEFAULT_COLOR);
            mInterpolator = attr.getInteger(R.styleable.RipplePulseLayout_pulse_interpolator,
